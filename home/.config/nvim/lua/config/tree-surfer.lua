...
--     sts.filtered_jump({"if_statement", "else_clause", "else_statement"}, true) -- > true means jump forward
-- end, opts)
-- vim.keymap.set("n", "your_keymap", function()
--     sts.filtered_jump({"if_statement", "else_clause", "else_statement"}, false) -- > false means jump backwards
-- end, opts)
...
--     sts.filtered_jump({"if_statement", "else_clause", "else_statement"}, false,
--                       {destination = "siblings"})
-- end, opts)
-- vim.keymap.set("n", "=", function()
--     sts.filtered_jump({"if_statement", "else_clause", "else_statement"}, true,
--                       {destination = "siblings"})
-- end, opts)
